...
<p style="border-left: 5px solid lightseagreen; padding-left: 0.5cm; font-size: 10pt">
  In diesem Dokument ist eine Gesamtübersicht über alle Einsatzkräfte, welche in der <b>Saison <?= $_GET['season'] ?></b> am Sanitäts- und Beckendienst in Rappenwört teilgenommen haben.<br>
  Die Interne Version beinhaltet eine Detailierte Auflistung, wieviel € an die Stadtgruppe und an die Einsatzkraft gehen.
</p>
<table class="table">
  <thead>
  <tr>
    <th>Einsatzkraft</th>
    <th>Anzahl Dienste</th>
    <th>Stunden</th>
    <th>Verdienst (EK)</th>
    <th>Verdienst (SG)</th>
    <th>Verdienst (Gesamt)</th>
  </tr>
  </thead>
  <tbody>
  <?php
