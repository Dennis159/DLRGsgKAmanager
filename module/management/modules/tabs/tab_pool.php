...
<table class="table align-items-center mb-0" style="width: 100%!important;" id="pooltable">
  ...
  foreach($res as $row){
    ...
    <?php
    include $_SERVER['DOCUMENT_ROOT']."/module/management/modules/modals/modal_detail.php";
    include $_SERVER['DOCUMENT_ROOT']."/module/management/modules/modals/modal_zurueck.php";
  }
  ?>
  </tbody>
</table>
