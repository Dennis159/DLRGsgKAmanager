...
<table>
  ...
  <tr><th colspan="10" class="text-centery text-center text-warning h5" style="padding-bottom: 0.5em!important;">Sanitätsausbildungen</th></tr>
    <tr>
  ...
  <tr><th colspan="10" class="text-center text-center text-warning h5" style="padding-top: 1em!important; padding-bottom: 0.3em!important;">Rettungsschwimmscheine</th></tr>
    <tr>
  ...
  <tr><th colspan="10" class="text-center text-warning h5" style="padding-top: 1em!important; padding-bottom: 0.3em!important;">Einsatzdienst / Bootswesen</th></tr>
    <tr>
    ...
    <tr>
      ...
      <td class="wem-17">BOS Sprechfunker - analog -</td>
    ...
    <tr>
      ...
      <td class="wem-17">BOS Sprechfunker - digital -</td>
...
<table>
  <tr><th colspan="2">Legende</th></tr>
    <tr><th colspan="2" class="text-warning" style="padding-top: 1em!important; padding-bottom: 0.3em!important;">ATN-Status</th></tr>
      <tr><th class="wem-2 text-center"><i class="text-danger  fa-solid fa-x"></i></th> <td class="wem-22">ATN nicht vorhanden</td></tr>
      <tr><th class="wem-2 text-center"><i class="text-warning fa-solid fa-hourglass-half"></i></th><td class="wem-22">Für LG angemeldet / Lfd. Lehrgang</td></tr>
      <tr><th class="wem-2 text-center"><i class="text-gallina fa-solid fa-eye"></i></i></th><td class="wem-22">ATN hochgeladen, muss überpüft werden</td></tr>
      <tr><th class="wem-2 text-center"><i class="text-success fa-solid fa-check"></i></th><td class="wem-22">ATN vorhanden (nicht im ISC)</td></tr>
      <tr><th class="wem-2 text-center"><i class="text-success fa-solid fa-check-double"></i></th><td class="wem-22">ATN vorhanden und im ISC eingetragen</td></tr>


    <tr><th colspan="2" class="text-warning" style="padding-top: 1em!important; padding-bottom: 0.3em!important;">ATN-Dokumente</th></tr>
      <tr><th class="wem-2 text-center"><i class="text-danger fa-solid fa-file-circle-xmark"></i></th><td class="wem-23">Kein ATN-Dokument verfügbar</td></tr>
      <tr><th class="wem-2 text-center"><i class="text-white fa-solid fa-file-pdf"></i></th><td class="wem-23">Dokument als PDF verfügbar</td></tr>
      <tr><th class="wem-2 text-center"><i class="text-white fa-solid fa-file-image"></i></th><td class="wem-23">Dokument als JPG oder PNG verfügbar</td></tr>
</table>